...
<div class="inicio">
    <div class="bg-light p-4 mb-4 rounded">
        <h1 class="text-center">Sobre a PHP Rec Types</h1>
    </div>

    <img class="img-lorem img-thumbnail m-4 rounded float-end" src="imagens/faqs.jpg" alt="Lorem Ipsum">
    ...
    <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa non accusantium itaque dolores odio iusto cum error assumenda consequuntur, excepturi, quis illum quae ab. Ab eaque deleniti perferendis soluta, molestiae quos quibusdam esse cupiditate vel amet, in voluptates blanditiis quod iste illum tempora non eum provident harum cum. Numquam, rerum.
    </p>
