    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <?php if(!isset($_SESSION["user"])) { ?>
                ...
                <li class='nav-item'><a href='login.php' class='nav-link <?php echo isActive('login.php') ?>'>Entrar</a></li>
            </ul>
            <?php } else { ?>
                <ul class='nav nav-pills'>
                <li class='nav-item'><a href='index.php' class='nav-link <?php echo isActive("index.php") ?>' aria-current='page'>Início</a></li>
                ...
                <li class='nav-item'><a href='FAQs.php' class='nav-link <?php echo isActive('FAQs.php') ?>'>FAQs</a></li>
                <li class='nav-item'><a href='contato.php' class='nav-link <?php echo isActive('contato.php') ?>'>Contato</a></li>
                <li class='nav-item'><a href='perfil.php' class='nav-link <?php echo isActive('perfil.php') ?>'>Perfil</a></li>
                <li class='nav-item'><a href='sair.php' class='nav-link <?php echo isActive('sair.php') ?>'>Sair</a></li>
                </ul>
            <?php } ?>
        </header>
